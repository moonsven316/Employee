                                                    ...
                                                    <div class="x_content">
                                                        ...
                                                        <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="hourly_wage" name="hourly_wage" class="form-control" value="0">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="basic_allowance" name="basic_allowance" class="form-control" value="0">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="business_allowance" name="business_allowance" class="form-control" value="0">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="position_allowance" name="position_allowance" class="form-control" value="0">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="technical_allowance" name="technical_allowance" class="form-control" value="0">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="item form-group">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 ">
                                                                    <input type="number" id="adjustment_allowance" name="adjustment_allowance" class="form-control" value="0">
                                                                </div>
                                                            </div>
